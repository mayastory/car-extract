window.FRLG_INTRO_SCENES = [
  {
    ...
    draw(ctx, t, state) {
      ...
      centerText(ctx, 'starter scene runner', 240, 175, 10, 0.7 * a);
    }
  },
  {
    id: 'gf-logo',
    ...
    draw(ctx, t) {
      ...
      ctx.stroke();
      ctx.restore();
      centerText(ctx, 'GAME FREAK', 240, 242, 18, a);
    }
  },
  {
    id: 'grass-closeup',
  ...
  },
  {
    ...
    draw(ctx, t) {
      ...
      centerText(ctx, 'web intro starter', 240, 160, 14, 0.75 * a);
      centerText(ctx, 'next target: extracted Packege assets + title scene', 240, 242, 11, 0.72 * a);
    }
  }
];
...
function centerText(ctx, text, x, y, size, alpha = 1) {
  ctx.save();
  ctx.globalAlpha = alpha;
