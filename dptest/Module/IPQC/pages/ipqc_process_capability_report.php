...
.qpc-target-grid{display:grid;grid-template-columns:minmax(0, 620px) 188px;gap:12px;align-items:start;max-width:820px;}
...
.qpc-target-ppk-line{display:flex;align-items:center;gap:8px;margin-bottom:6px;}
...
.qpc-target-range{width:100%;min-width:0;accent-color:#b9d8ff;}
