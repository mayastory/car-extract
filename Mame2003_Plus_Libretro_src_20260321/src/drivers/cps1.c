...
ROM_START( wofchk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "tk2k=ch=_23.8f", 0x000000, 0x80000, CRC(4d498441) SHA1(b87f7ef4802ce560750a1f7c240cf3d92c0a4052) )
	ROM_LOAD16_WORD_SWAP( "tk2k=ch=_22.7f", 0x080000, 0x80000, CRC(88854a0b) SHA1(9f69d53c9313cb706dec1542d78db4d8906d0da4) )
